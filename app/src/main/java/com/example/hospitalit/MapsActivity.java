...
public class MapsActivity extends FragmentActivity implements
                    ...
                    try
                    {
                        ...
                        if (addressList != null)
                        {
                            for (int i=0; i<addressList.size(); i++)
                            {
                                ...
                                String country=userAddress.getCountryName();
                                if (country.length()>0)
                                {
                                    userMarkerOptions.snippet(country);
                                }
                                if (marker != null)
                                {
                                    marker.remove();
    ...
    private String getUrl(double latitide, double longitude, String nearbyPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyCz5QxcqmiRTi54m_-uOXEX2wr5BxD5MCA");
            ...
            if (mMap != null) {
                ...
                mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
                    ...
                    public void onMapLongClick(LatLng latLng) {
                        ...
                        LatLng latLng1 = new LatLng(add.getLatitude(), add.getLongitude());
                        MarkerOptions userMarkerOptions = new MarkerOptions();

                        userMarkerOptions.position(latLng);
                        userMarkerOptions.title(add.toString());
                    }
                });
